...
const styles = StyleSheet.create({
  ...
  sheetTitle: { fontFamily: font.family, fontSize: font.size.lg, fontWeight: font.weight.semibold, marginBottom: space[2] },
  ...
  stepGlyph: { fontSize: 20, fontWeight: font.weight.medium },
  stepValue: { minWidth: TOUCH, textAlign: 'center', fontSize: font.size.lg, fontWeight: font.weight.semibold },
  ...
  chipLabel: { fontFamily: font.family, fontSize: font.size.sm, fontWeight: font.weight.medium },
  label: { fontFamily: font.family, fontSize: font.size.xs, fontWeight: font.weight.medium, letterSpacing: font.tracking.eyebrow, marginTop: space[8], marginBottom: space[3] },
